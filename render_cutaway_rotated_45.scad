// Same diagonal cutaway, but adapter rotated 45 degrees clockwise (looking from top)
...
// Rotate the entire model 45 degrees around Z axis
rotate([0, 0, -45])  // Negative for clockwise when viewing from top
difference() {
    difference() {
